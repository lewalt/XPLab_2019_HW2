...
author: "Deniz Gün and Leona Waltert"
output:
  html_document
---
...
*ANSWER:*
R version 3.5.3 on platform x86_64-w64-mingw32/x64
...
*ANSWER:*
The variable supp is of data type factor.
...
# YOUR CODE HERE
iris_tibble_oj <- filter(iris_tibble, supp=="OJ")
count(iris_tibble_oj)
...
*ANSWER:*
There are 30 from the orginally 60 datapoints (guinea pigs) left.
...
# YOUR CODE HERE
iris_tibble_vc <- filter(iris_tibble, supp=="VC", dose >= 1.0)

print(iris_tibble_vc)
...
*ANSWER:*
The mean tooth length for guinea pigs that received orange juice is 20.7.
...
*ANSWER:*
In general there is a positive correlation between dosage and length. For low and medium dosage there seems to be a difference between the two types of supplement, guinea pigs that received OJ show a greater tooth length than those that got VC. For high dosage this effect is not visible, however, VC shows a greater lenght variability between the individuals than OJ.
